...
class JFShareView: UIView {
    ...
    private func prepareUI() {
        ...
        containerView.snp.makeConstraints { (make) in
            ...
            make.bottom.equalTo(layoutVertical(iPhone: 226)) // 高226 但只会漏出206高度
            make.height.equalTo(layoutVertical(iPhone: 226))
        }
        
        lineView.snp.makeConstraints { (make) in
            make.left.right.equalTo(0)
            make.height.equalTo(0.5)
            make.bottom.equalTo(layoutVertical(iPhone: -64))
        }
        ...
        cancelButton.snp.makeConstraints { (make) in
            make.left.right.equalTo(0)
            make.height.equalTo(layoutVertical(iPhone: 44))
    ...
    func showShareView() {
        ...
        containerView.snp.updateConstraints { (make) in
            make.bottom.equalTo(layoutVertical(iPhone: 20))
        }
    ...
    func dismissShareView() {
        containerView.snp.updateConstraints { (make) in
            make.bottom.equalTo(layoutVertical(iPhone: 226))
        }
    ...
    private lazy var containerView: UIView = {
        ...
        view.layer.cornerRadius = layoutVertical(iPhone: 20)
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: SCREEN_WIDTH / 4.0, height: layoutVertical(iPhone: 160))
